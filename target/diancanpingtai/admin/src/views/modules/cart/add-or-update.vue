<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="菜品表名" prop="tablename">
          <el-input v-model="ruleForm.tablename" 
              placeholder="菜品表名" clearable  :readonly="ro.tablename"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="菜品表名" prop="tablename">
              <el-input v-model="ruleForm.tablename" 
                placeholder="菜品表名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                  <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="菜品id" prop="goodid">
          <el-input v-model="ruleForm.goodid" 
              placeholder="菜品id" clearable  :readonly="ro.goodid"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="菜品id" prop="goodid">
              <el-input v-model="ruleForm.goodid" 
                placeholder="菜品id" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="菜品名称" prop="goodname">
          <el-input v-model="ruleForm.goodname" 
              placeholder="菜品名称" clearable  :readonly="ro.goodname"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="菜品名称" prop="goodname">
              <el-input v-model="ruleForm.goodname" 
