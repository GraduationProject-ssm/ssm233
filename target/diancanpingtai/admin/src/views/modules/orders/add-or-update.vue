  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="菜品名称" prop="goodname">
              <el-input v-model="ruleForm.goodname" 
                placeholder="菜品名称" readonly></el-input>
                                    ...
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.picture" label="菜品图片" prop="picture">
          <file-upload
          tip="点击上传菜品图片"
          action="file/upload"
          :limit="3"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.picture" label="菜品图片" prop="picture">
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.address = true;
            continue;
                                        ...
                                        this.statusOptions = "未支付,已支付,已完成,已取消,已退款,已派送".split(',')
                                              },
                                                                                                                        // 多级联动参数
                                                                                                                                                        info(id) {
      this.$http({
