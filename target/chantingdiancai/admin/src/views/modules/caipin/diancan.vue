        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        <el-button v-if="isAuth('caipin','点餐') && contents.btnAdAllIcon == 1 && contents.btnAdAllIconPosition == 1" type="success" icon="el-icon-plus" @click="deleteHandler()">{{ contents.btnAdAllFont == 1?'确定订单':'' }}</el-button>
                        <el-button v-if="isAuth('caipin','点餐') && contents.btnAdAllIcon == 1 && contents.btnAdAllIconPosition == 2" type="success" @click="deleteHandler()">{{ contents.btnAdAllFont == 1?'确定订单':'' }}<i class="el-icon-plus el-icon--right" /></el-button>
                        <el-button v-if="isAuth('caipin','点餐') && contents.btnAdAllIcon == 0" type="success" @click="deleteHandler()">{{ contents.btnAdAllFont == 1?'确定订单':'' }}</el-button>
                    </el-form-item>
                </el-row>
            </el-form>
