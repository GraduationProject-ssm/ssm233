    ...
    <div class="addEdit-block">
        ...
        >
            <el-row>
                   ...
                   <el-col :span="12">
                       <el-form-item class="select" v-if="type!='info'"  label="菜品名称" prop="hxTypes">
                           <el-select v-model="ruleForm.hxTypes" placeholder="请选择菜品名称">
                               <el-option
                       ...
                       <div v-else>
                           <el-form-item class="input" label="菜品名称" prop="hxTypes">
                               <el-select v-model="ruleForm.hxTypes" placeholder="请选择菜品名称" readonly>
                                   <el-option
                                           v-for="(item,index) in hxTypesSelectSearch"
                                           v-bind:key="index"
                                           :label="item.name"
                      ...
                      <el-col :span="12">
                          <el-form-item class="input" v-if="type!='info'" label="菜品单价" prop="money">
                              <el-input v-model="ruleForm.money" type="number"
                                        placeholder="菜品单价"></el-input>
                          </el-form-item>
                          <div v-else>
                              <el-form-item class="input" label="菜品单价" prop="money">
                                  <el-input v-model="ruleForm.money"
                                            placeholder="菜品单价" readonly></el-input>
                              </el-form-item>
                          </div>
                      </el-col>
                   <el-col :span="24">
                       <el-form-item class="upload" v-if="type!='info' && !ro.imgPhoto" label="菜品图片" prop="imgPhoto">
                           <file-upload
                                   tip="点击上传菜品图片"
                                   action="file/upload"
                                   :limit="3"
                     ...
                     <el-col :span="24">
                         ...
                         <div v-else>
                             <el-form-item v-if="ruleForm.caipinContent" label="菜品描述" prop="caipinContent">
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                                 ...
                                 if(o=='caipinContent'){
                                     this.ruleForm.caipinContent = obj[o];
                                     this.ro.caipinContent = true;
                                     continue;
                                 }
                    }
                }
