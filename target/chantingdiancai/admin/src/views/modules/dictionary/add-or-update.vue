    ...
    <div class="addEdit-block">
        ...
        >
            <el-row>
                      ...
                      <el-col :span="12">
                          <el-form-item class="input" v-if="type!='info'" label="字段" prop="dicCode">
                              <el-input v-model="ruleForm.dicCode"
                                        placeholder="字段" clearable></el-input>
                          </el-form-item>
                          <div v-else>
                      ...
                      <el-col :span="12">
                          <el-form-item class="input" v-if="type!='info'" label="字段名" prop="dicName">
                              <el-input v-model="ruleForm.dicName"
                                        placeholder="字段名" clearable></el-input>
                          </el-form-item>
                          <div v-else>
                      ...
                      <el-col :span="12">
                          <el-form-item class="input" v-if="type!='info'" label="编码名字" prop="indexName">
                              <el-input v-model="ruleForm.indexName"
                                        placeholder="编码名字" clearable></el-input>
                          </el-form-item>
                          <div v-else>
                      ...
                      <el-col :span="12">
                          <el-form-item class="input" v-if="type!='info'" label="父字段id" prop="superId">
                              <el-input v-model="ruleForm.superId" type="number"
                                        placeholder="父字段id"></el-input>
                          </el-form-item>
                          <div v-else>
                              <el-form-item class="input" label="父字段id" prop="superId">
                                  <el-input v-model="ruleForm.superId"
                                            placeholder="父字段id" readonly></el-input>
                              </el-form-item>
                          </div>
                      </el-col>
            </el-row>
