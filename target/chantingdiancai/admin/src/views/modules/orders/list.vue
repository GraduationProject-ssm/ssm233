    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
        <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                  ...
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1" prefix-icon="el-icon-search" v-model="searchForm.goodname" placeholder="菜品名称" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2" suffix-icon="el-icon-search" v-model="searchForm.goodname" placeholder="菜品名称" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 0" v-model="searchForm.goodname" placeholder="菜品名称" clearable></el-input>
                </el-form-item>
                                                                                                                                                                                                                                                    <el-form-item>
        ...
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
		    ...
		    label="地址">
		     <template slot-scope="scope">
                ...
                <el-button v-if="isAuth('orders'+'/'+orderStatus,'派送') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="primary" icon="el-icon-edit" size="mini" @click="updateHandler(scope.row)">{{ contents.tableBtnFont == 1?'派送':'' }}</el-button>
                <el-button v-if="isAuth('orders'+'/'+orderStatus,'派送') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="primary" size="mini" @click="updateHandler(scope.row)">{{ contents.tableBtnFont == 1?'派送':'' }}<i class="el-icon-edit el-icon--right" /></el-button>
                <el-button v-if="isAuth('orders'+'/'+orderStatus,'派送') && contents.tableBtnIcon == 0" type="primary" size="mini" @click="updateHandler(scope.row)">{{ contents.tableBtnFont == 1?'派送':'' }}</el-button>
