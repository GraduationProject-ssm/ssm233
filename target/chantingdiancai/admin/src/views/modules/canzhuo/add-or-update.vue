    ...
    <div class="addEdit-block">
        ...
        >
            <el-row>
                      ...
                      <el-col :span="12">
                          <el-form-item class="input" v-if="type!='info'" label="餐桌名称" prop="name">
                              <el-input v-model="ruleForm.name"
                                        placeholder="餐桌名称" clearable></el-input>
                          </el-form-item>
                          <div v-else>
                              <el-form-item class="input" label="餐桌名称" prop="name">
                                  <el-input v-model="ruleForm.name"
                      ...
                      <el-col :span="12">
                          <el-form-item class="input" v-if="type!='info'" label="餐桌位置" prop="tableLocation">
                              <el-input v-model="ruleForm.tableLocation"
                                        placeholder="餐桌位置" clearable></el-input>
                          </el-form-item>
                          <div v-else>
                              <el-form-item class="input" label="餐桌位置" prop="tableLocation">
                                  <el-input v-model="ruleForm.tableLocation"
        ...
        data() {
            ...
            return {
                ...
                rules: {
                        ...
                        sfTypes: [
                        { required: true, message: '是否预定不能为空', trigger: 'blur' },
                    ],
            },
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                                 ...
                                 if(o=='tableLocation'){
                                     this.ruleForm.tableLocation = obj[o];
                                     this.ro.tableLocation = true;
                                     continue;
                                 }
